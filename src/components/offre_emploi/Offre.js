...
console.log(search);
 ...
 <>  
   ...
   <Header/>
    ...
    <Card.Title className='text px-4 forms-control '>  <div className='pro'><input className='imputsearch' placeholder='search..'
            name="search"
            type="search" 
            onChange={(e)=>setSearch(e.target.value)}
             /> <FaSearch className='pt-1'/></div>
             
             </Card.Title>
             <div> <button type='submit' className=' ajou' onClick={()=>navigate('/Stepper')}>Ajouter</button>
